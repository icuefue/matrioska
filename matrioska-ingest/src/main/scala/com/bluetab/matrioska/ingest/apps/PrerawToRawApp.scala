...
class PrerawToRawApp extends LinxApp {
  ...
  def addErrorMessage(errorMessageBuilder: StringBuilder, mask: com.bluetab.matrioska.ingest.beans.Mask, badFiles: Seq[AuditFileData]) = {
  ...
  def addErrorMessageNoControlado(errorMessageBuilder: StringBuilder, mask: com.bluetab.matrioska.ingest.beans.Mask, filenames: Seq[String]) = {
